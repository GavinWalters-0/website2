...
const _basf = <Image className="h-[3rem] w-[5rem]" src={basf_logo} alt={"t"}/>

import ford_logo from "@/gavin/assets/clients/thumbnail_ford_ee0e9b2d86.webp"
const _ford = <Image className="h-[3rem] w-[5rem]" src={ford_logo} alt={"t"}/>
import gmc_logo from "@/gavin/assets/clients/thumbnail_gmc_95006a2d52.webp"
const _gmc_logo = <Image className="h-auto w-auto max-h-[5rem] max-w-[5rem]" src={ford_logo} alt={"t"}/>
...
const logos = [
  acca, aws, mca, pfi, rses, aia, dcc,
  basf_logo, ford_logo, gmc_logo,iso_logo,vw_logo,mmc
];
      ...
      <div className="glide" ref={glideRef}>
        <div className="glide__track" data-glide-el="track">
          <ul className="glide__slides flex items-center justify-center">
                  <div key={`l-0`} className="glide__slide">
                    <div className='flex items-center justify-center w-full h-full'>
					         {_basf} 
                    </div>
                  </div>
                  <div key={`l-1`} className="glide__slide">
                    <div className='flex items-center justify-center w-full h-full'>
					         {_ford} 
                    </div>
                  </div>
